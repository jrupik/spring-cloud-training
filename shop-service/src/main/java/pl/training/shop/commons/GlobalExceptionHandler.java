...
import pl.training.payments.ExceptionTransferObject;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionTransferObject> onPaymentInitializationException(PaymentInitializationException exception, Locale locale) {
        return createResponse(exception, SERVICE_UNAVAILABLE, locale);
    }
